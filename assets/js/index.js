...
import {
  ...
  faAngleDoubleDown, faFileCsv, faUnlockAlt, faMapMarkedAlt, faCog, faFlag, faChartBar, faDoorClosed,
  faComments, faImages, faSave, faHome, faEye, faCheck, faPlus, faBackspace, faMinus,
  faGripLines, faTimes, faTrashAlt, faMask, faAward, faWarehouse, faExpandArrowsAlt,
  faCompressArrowsAlt, faBroom, faClock, faList,
  faInfoCircle, faReply, faBars, faUserCircle, faMoneyCheckAlt, faDollarSign, faFileInvoiceDollar, faBuilding,
  faTrailer, faQuestion, faMagic, faBook, faThermometerHalf, faTruckLoading,
  faTruck, faFill, faTools, faBullhorn, faCalculator, faChartLine, faPallet, faFile,
  faMarker, faPencilAlt, faPhone, faTags, faThumbtack, faCut, faBalanceScaleLeft, faDesktop,
  faTabletAlt, faPlug, faFrown, faMeh, faPeopleCarry, faSmile, faUserClock, faUserEdit, 
  faCogs, faShippingFast, faAsterisk, faBell, faCommentAlt, faBoxes, faDolly, faDollyFlatbed
...
library.add(faEye, faAngleUp, faAngleDown, faFilter, faExclamationTriangle, faSearch,
  ...
  faTrash, faRecycle, faInfoCircle, faMapMarkedAlt, faCog, faFlag, faChartBar, faDoorClosed, faUnlockAlt,
  faUser, faFileUpload, faPrint, faComments, faImages, faSave, faHome, faCheck, faPlus,
  faBackspace, faMinus, faGripLines, faTimes, faExpandArrowsAlt, faCompressArrowsAlt,
  faTrashAlt, faReply, faMask, faAward, faWarehouse, faBroom, faClock, faList,
